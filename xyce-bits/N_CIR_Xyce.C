...
{
  TimeVoltagePairsSzOp() { maxpts_ = 0; }
...
// Purpose        : get the maximum number of points for any ADC returned by
//                  getTimeVoltagePairs. Useful for allocating storage
//                  being passed in to getTimeVoltagePairs
//
// Scope          : public
// Creator        : Rajit Manohar
// Creation Date  : 10/11/2021
//----------------------------------------------------------------------------
bool Simulator::getTimeVoltagePairsSz(int &sz)
{
  bool success = false;
